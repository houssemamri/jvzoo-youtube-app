  ...
  return (
    <>
      ...
      <div className="relative bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 2xl:justify-start md:space-x-10">
            ...
            <div className="-mr-2 -my-2 2xl:hidden xl:hidden lg:hidden ">
              <button
                type="button"
            ...
            <nav className="hidden 2xl:flex xl:flex lg:flex md:flex space-x-10">
            ...
            */}{" "}
            ...
            <div className="hidden 2xl:flex xl:flex lg:flex items-center justify-end 2xl:flex-1 xl:flex-1 lg:flex-1 lg:w-0">
              <a
                href="#"
    ...
    */}
        ...
        <div
          className={
            open
              ? "opacity-100 scale-100 transition ease-out duration-200 absolute top-0 inset-x-0 p-2 transition transform origin-top-right 2xl:hidden xl:hidden lg:hidden md:hidden"
              : "opacity-0 scale-95 absolute top-0 inset-x-0 p-2 transition transform origin-top-right 2xl:hidden"
          }
        >
